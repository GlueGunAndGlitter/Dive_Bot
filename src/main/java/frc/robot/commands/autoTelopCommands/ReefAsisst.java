...
public class ReefAsisst extends Command {    
    ...
    public void initialize() {
        Constants.ArmAngleChangeConstants.L4_POSITION = -30;
    ...
    public void execute() {
        ...
        angleError = target.getRotation().getDegrees() - Math.IEEEremainder(s_Swerve.getHeading().getDegrees(), 360);
    ...
    private boolean atTolerance() {
        ...
        return Math.abs(error.getX()) < Constants.ReefAssistConstants.X_TOLERANCE &&
               ...
               Math.abs(angleError) < Constants.ReefAssistConstants.ROTATION_TOLERANCE;
    }
